defmodule CustyardWeb.CoreComponents do
  @moduledoc """
  ...
  def flash_group(assigns) do
    ~H"""
    <div id={@id} data-testid="flash-group">
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(CustyardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CustyardWeb.Gettext, "errors", msg, opts)
    end
  end
